...
public class PowerUsageSummary extends PowerUsageBase implements OnLongClickListener,
    ...
    protected void refreshUi(@BatteryUpdateType int refreshType) {
        ...
        mBatteryTemp.setSubtitle(
                com.android.internal.util.cr.CrUtils.mccCheck(getContext()) ?
                com.android.internal.util.cr.CrUtils.batteryTemperature(getContext(), true) + "°F" :
                com.android.internal.util.cr.CrUtils.batteryTemperature(getContext(), false) + "°C");
    }
