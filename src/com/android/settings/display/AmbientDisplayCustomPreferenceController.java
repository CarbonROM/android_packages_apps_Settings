...
public class AmbientDisplayCustomPreferenceController extends AbstractPreferenceController implements
    ...
    private static final String KEY_AMBIENT_DISPLAY_CARBON = "ambient_display_carbon";
    ...
    public String getPreferenceKey() {
        return KEY_AMBIENT_DISPLAY_CARBON;
    }
    ...
    public boolean isAvailable() {
        return CrUtils.isAppInstalled(mContext.getApplicationContext(), PACKAGE_CUSTOM_DOZE);
    }
}
