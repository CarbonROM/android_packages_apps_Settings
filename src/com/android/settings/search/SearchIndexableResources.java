...
import com.android.settings.carbon.fuelgauge.BatteryLightSettings;
...
public final class SearchIndexableResources {
    ...
    static {
        ...
        addIndex(AdvancedOptions.class, R.xml.advanced_options, R.drawable.ic_buttons);
        addIndex(Buttons.class, R.xml.buttons, R.drawable.ic_buttons);
        addIndex(CarbonGesturesSettings.class, R.xml.carbon_gestures, R.drawable.ic_gestures);
