...
public class RemotePreference extends SelfRemovingPreference
    ...
    public static final String ACTION_REFRESH_PREFERENCE =
            "org.carbonrom.intent.action.REFRESH_PREFERENCE";

    public static final String ACTION_UPDATE_PREFERENCE =
            "org.carbonrom.intent.action.UPDATE_PREFERENCE";

    public static final String META_REMOTE_RECEIVER =
            "org.carbonrom.settings.summary.receiver";

    public static final String META_REMOTE_KEY =
            "org.carbonrom.settings.summary.key";

    public static final String EXTRA_ENABLED = ":carbon:pref_enabled";
    public static final String EXTRA_KEY = ":carbon:pref_key";
    public static final String EXTRA_SUMMARY = ":carbon:pref_summary";
