...
public class CreateShortcut extends LauncherActivity {
    ...
    protected Intent getTargetIntent() {
        ...
        targetIntent.addCategory("com.android.settings.carbon.SHORTCUT");
    ...
    protected void onListItemClick(ListView l, View v, int position, long id) {
        ...
        shortcutIntent.setClass(getApplicationContext(), CarbonSettingsActivity.class);
        shortcutIntent.setAction("com.android.settings.carbon.START_NEW_FRAGMENT");
